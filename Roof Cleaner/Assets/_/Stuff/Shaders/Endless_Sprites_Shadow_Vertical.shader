...
Shader "Endless/Sprites/Shadow_Vertical"
{
	Properties
	{
		...
		_TestRatio("TestRatio", Range(0,1)) = 1
	}
		...
		CGPROGRAM
			...
			*/
			...
			v2f vert(appdata_t IN)
			{
				...
				IN.vertex.y *= (.5f - _MonthRatio) * 1.5f;
				//IN.vertex.y *= (.5f - 2) * 1;
				//OUT.vertex = UnityObjectToClipPos(IN.vertex + float4(IN.vertex.y * .1 * (.5f - _MonthRatio) * 20, 0w, 0, 0));
