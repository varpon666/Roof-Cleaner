...
namespace V_AnimationSystem {
    ...
    public class V_UnitSkeleton {
        ...
        public static void AddSquare(int bodyPartIndex, int verticesIndex, Vector3[] verticesArr, int uvsIndex, Vector2[] uvsArr, int trianglesIndex, int[] trianglesArr, Vector3 localPos, Vector3 v00, Vector3 v01, Vector3 v10, Vector3 v11, Vector2[] squareUV) {
            /* 01
             * 11
             * 00
             * 10 */
            localPos += new Vector3(0, 0, +.01f * bodyPartIndex);
